...
var config = [
    {id: 'regions','url':'https://health-security.rnbo.gov.ua/api/vaccination/process/table?perPage=25&page=1&orderBy=date&orderDir=desc&dose=1&distributionBy=vaccine&vaccines=&period=daily&aggregateBy=regions&valueType=quantity&regionId=',
    table_ids:[]},
    {id: 'vaccination1','url':'https://health-security.rnbo.gov.ua/api/vaccination/process/chart?vaccines=&dose=1&distributionBy=vaccine&regionId=',
    table_ids:["vax1_day",'vax1_all']},
    {id: 'vaccination2','url':'https://health-security.rnbo.gov.ua/api/vaccination/process/chart?vaccines=&dose=2&distributionBy=vaccine&regionId=',
