...
var population_regions = [{"ua":"Вінницька область", "pop":1522078, "name":"Винницкая"},
{"ua":"Волинська область", "pop":1025755, "name":"Волынская"},
{"ua":"Дніпропетровська область", "pop":3127604, "name":"Днепропетровская"},
{"ua":"Донецька область", "pop":4088265, "name":"Донецкая"},
{"ua":"Житомирська область", "pop":1189820, "name":"Житомирская"},
{"ua":"Закарпатська область", "pop":1247718, "name":"Закарпатская"},
{"ua":"Запорізька область", "pop":1658319, "name":"Запорожская"},
{"ua":"Івано-Франківська область", "pop":1357168, "name":"Ивано-Франковская"},
{"ua":"Київська область", "pop":1787526, "name":"Киевская"},
{"ua":"Кіровоградська область", "pop":914939, "name":"Кировоградская"},
{"ua":"Луганська область", "pop":2115791, "name":"Луганская"},
{"ua":"Львівська область", "pop":2490037, "name":"Львовская"},
{"ua":"Миколаївська область", "pop":1102843, "name":"Николаевская"},
{"ua":"Одеська область", "pop":2361656, "name":"Одесская"},
{"ua":"Полтавська область", "pop":1365518, "name":"Полтавская"},
{"ua":"Рівненська область", "pop":1146366, "name":"Ровненская"},
{"ua":"Сумська область", "pop":1047999, "name":"Сумская"},
{"ua":"Тернопільська область", "pop":1027431, "name":"Тернопольская"},
{"ua":"Харківська область", "pop":2622796, "name":"Харьковская"},
{"ua":"Херсонська область", "pop":1012337, "name":"Херсонская"},
{"ua":"Хмельницька область", "pop":1238564, "name":"Хмельницкая"},
{"ua":"Черкаська область", "pop":1172692, "name":"Черкасская"},
{"ua":"Чернівецька область", "pop":894579, "name":"Черновецкая"},
{"ua":"Чернігівська область", "pop":970858, "name":"Черниговская"},
{"ua":"м. Київ", "pop":2953956, "name":"Киев"}]
var all_number = 0,
    all_today_number = 0,
    pfizer = 0,
    astra = 0,
    ...
    function run(dict,data) {
        if (dict.id == 'vaccination1' || dict.id == 'vaccination2') {
            ...
            if (iter == 0) {
                ...
                d3.select('#progress_bar_Pfizer-BioNTech').html('<div class="bar" style="height: 15px; width: '+pfizer_percent+'%; position: relative; background-color: rgb(0,68,27); left: 0%;"></div><span style="position: absolute;right: 4px;top: 1px;font-size: 11px; vertical-align: bottom;">'+Math.round(pfizer_percent)+'%</span>')
                ...
                d3.select('#progress_bar_AstraZeneca').html('<div class="bar" style="height: 15px; width: '+astra_percent+'%; position: relative; background-color: rgb(0,68,27); left: 0%;"></div><span style="position: absolute;top: 1px;right: 4px; font-size: 11px; vertical-align: bottom;">'+Math.round(astra_percent)+'%</span>')
                ...
                d3.select('#progress_bar_SinovacBiotech').html('<div class="bar" style="height: 15px; width: '+coronavac_percent+'%; position: relative; background-color: rgb(0,68,27); left: 0%;"></div><span style="position: absolute;top: 1px;right: 4px; font-size: 11px; vertical-align: bottom;">'+Math.round(coronavac_percent)+'%</span>')
            }
            ...
            d3.select('#progress_bar0'+dose).html('<div class="bar" style="height: 15px; width: '+percent+'%; position: relative; background-color: rgb(0,68,27); left: 0%;"></div><span style="position: absolute;top: 1px;right: 4px;font-size: 11px; vertical-align: bottom;">'+Math.round(percent)+'%</span>')
        } 
        if (dict.id == 'regions1' || dict.id == 'regions2') {
            ...
            population_regions.forEach(function(x,i) {
                ...
                value = obj['AstraZeneca']+obj['Pfizer-BioNTech']+obj['Sinovac Biotech']
            ...
            paste_id.forEach(function(paste) {
                for (i=0;i<3;i++) {   
                    ...
                    if (paste == 'all') {
                        ...
                        d3.select('#progress_bar_oblast'+i).html('<div class="bar" style="height: 15px; width: '+percent+'%; position: relative; background-color: rgb(0,68,27); left: 0%;"></div><span style="position: absolute;top: 1px;right: 4px;font-size: 11px; vertical-align: bottom;">'+Math.round(percent)+'%</span>')
                    }
                    
                }
            })
            d3.select('#date3').text(dayMonth(new Date())+" на 100 000 нас.")
