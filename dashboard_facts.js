...
var supplies = [
{"State": "Международные партнеры","COVAX": 2137500,"ДП Медичні закупівлі України": 0,"Crown Agents": 0,"total": 2137500},
{"State": "Государственный бюджет","COVAX": 0,"ДП Медичні закупівлі України": 1713316,"Crown Agents": 934070,"total": 2647386}
]
var vaccines_used = [
{"State": "Люди 60+","AstraZeneca": 361573,"Pfizer-BioNTech": 23819,"Sinovac Biotech": 145350,"total": 530742},
{"State": "Медики","AstraZeneca": 353954,"Pfizer-BioNTech": 151031,"Sinovac Biotech": 19325,"total": 524310},
{"State": "Учителя","AstraZeneca": 59873,"Pfizer-BioNTech": 314234,"Sinovac Biotech": 31619,"total": 405726},
{"State": "Госбезопасность","AstraZeneca": 63231,"Pfizer-BioNTech": 97049,"Sinovac Biotech": 162247,"total": 322527},
{"State": "Другие","AstraZeneca": 62425,"Pfizer-BioNTech": 32541,"Sinovac Biotech": 180328,"total": 275294},
{"State": "Соцработник","AstraZeneca": 84704,"Pfizer-BioNTech": 43949,"Sinovac Biotech": 48922,"total": 177575},
{"State": "Люди с болезнями","AstraZeneca": 63770,"Pfizer-BioNTech": 10453,"Sinovac Biotech": 102334,"total": 176557},
{"State": "Военные","AstraZeneca": 101474,"Pfizer-BioNTech": 4787,"Sinovac Biotech": 23326,"total": 129587},
{"State": "Дома пристарелых","AstraZeneca": 3527,"Pfizer-BioNTech": 54255,"Sinovac Biotech": 133,"total": 57915},
{"State": "Критическая инфрастр.","AstraZeneca": 1951,"Pfizer-BioNTech": 9723,"Sinovac Biotech": 31639,"total": 43313},
{"State": "Публичные лица","AstraZeneca": 27287,"Pfizer-BioNTech": 4601,"Sinovac Biotech": 830,"total": 32718}
]
...
var tooltipBee = d3.select("body")
  ...
  svg.append("g")
    ...
    .on("mouseover", function(d) {
            ...
            html += '<p>Вакцинировано за день: <b>'+numberWithSpaces(total)+'</b></p>'
...
function horizontalBarChart(w,data,id) {
    ...
    if (id == 'supplies') {
        ...
        start_height = 400
        var left = 100;
        var title = 'Какие вакцины используют'
        var keys = ["AstraZeneca","Pfizer-BioNTech","Sinovac Biotech"]
        var colorPalette = ['#B07AA1','#72A3C9','#E74545']
    }
    var vacKeys = ["Люди 60+","Медики","Учителя","Госбезопасность","Другие","Соцработник","Люди с болезнями","Военные","Ті, хто проживає у будинках для людей похилого віку","Працівники критичної інфраструктури","Публичные лица"]
    d3.select("#"+id).html('')
    var margin = {top: 50, right: 30, bottom: 20, left: left},
        width = start_width - margin.left - margin.right,
    ...
    g.append("g")
        ...
        .on("mouseover", function(d) {
            if (d[0] == 0 && d.data.State == 'Международные партнеры') {
                var key = 'COVAX'
            } else if (d.data.State == 'Государственный бюджет' && d[0] == 0) {
            ...
            if (d.data.State == 'Международные партнеры' || d.data.State == 'Государственный бюджет') {
    ...
    if (id == 'supplies') {
        g.append("g")
            ...
            .text(function(d) {
                if (d[0] == 0 && d.data.State == 'Международные партнеры') {
                    return 'COVAX'
                } else if (d.data.State != 'Международные партнеры' && d[0] == 0) {
