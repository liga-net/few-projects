...
{"State": "Будинки для людей похилого віку","AstraZeneca": 3527,"Pfizer-BioNTech": 54255,"Sinovac Biotech": 133,"total": 57915},
...
function horizontalBarChart(w,data,id) {
    ...
    var vacKeys = ["Люди віком 60+","Медики","Вчителі","Державна безпека","Інші","Соцпрацівник","Люди з хворобами","Військові","Ті, хто проживає у будинках для людей похилого віку","Працівники критичної інфраструктури","Публічні особи"]
    d3.select("#"+id).html('')
    var margin = {top: 50, right: 30, bottom: 20, left: left},
        width = start_width - margin.left - margin.right,
