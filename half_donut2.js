...
var fullData = [
{"name": "LPG","Внутреннее производство": 415871.245,"Импорт др.": 1566393.317394,"Россия": 689486.074,"total": 2671750.636394,"Данные": "А-95"},
{"name": "Дизтопливо","Внутреннее производство": 1184500,"Импорт др.": 6262077.158,"Россия": 2613922.593,"total": 10060499.751,"Данные": "А-95"},
{"name": "Бензины","Внутреннее производство": 1044500,"Импорт др.": 1099436.226,"Россия": 0,"total": 2143936.226,"Данные": "А-95"},
{"name": "Уголь","Внутреннее производство": 20428555.28028,"Импорт др.": 17574065.31972,"Россия": 11872892.86272,"total": 49875513.46272,"Данные": "Госстат, таможня"},]
...
svgLegend.append("text").attr("x", 20).attr("y", 19).text("Внутреннее производство").style("font-size", "14px").attr("alignment-baseline","left")
svgLegend.append("text").attr("x", 20).attr("y", 35).text("Импорт др.").style("font-size", "14px").attr("alignment-baseline","left")
svgLegend.append("text").attr("x", 20).attr("y", 51).text("Импорт из России").style("font-size", "14px").attr("alignment-baseline","left")
var full_data = fullData[number]
var text = full_data['name']
var data = [full_data['Внутреннее производство'],full_data['Импорт др.'],full_data['Россия']]
