...
var fullData = [
{"name": "LPG","Внутрішнє виробництво": 415871.245,"Інший імпорт": 1566393.317394,"Росія": 689486.074,"total": 2671750.636394,"Дані": "А-95"},
{"name": "Дизпаливо","Внутрішнє виробництво": 1184500,"Інший імпорт": 6262077.158,"Росія": 2613922.593,"total": 10060499.751,"Дані": "А-95"},
{"name": "Бензини","Внутрішнє виробництво": 1044500,"Інший імпорт": 1099436.226,"Росія": 0,"total": 2143936.226,"Дані": "А-95"},
{"name": "Вугілля","Внутрішнє виробництво": 20428555.28028,"Інший імпорт": 17574065.31972,"Росія": 11872892.86272,"total": 49875513.46272,"Дані": "Держстат, митниця"},]
...
svgLegend.append("text").attr("x", 20).attr("y", 19).text("Внутрішнє виробництво").style("font-size", "14px").attr("alignment-baseline","left")
svgLegend.append("text").attr("x", 20).attr("y", 35).text("Інший імпорт").style("font-size", "14px").attr("alignment-baseline","left")
...
var data = [full_data['Внутрішнє виробництво'],full_data['Інший імпорт'],full_data['Росія']]
