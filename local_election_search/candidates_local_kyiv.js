if(document.createStyleSheet) {
    document.createStyleSheet('https://cdn.jsdelivr.net/gh/liga-net/few-projects/local_election_search/candidates_local1.css');
   }
   else {
    var styles = "@import url('https://cdn.jsdelivr.net/gh/liga-net/few-projects/local_election_search/candidates_local1.css');";
...
function getValue(file){
    var value = $.ajax({ 
       url: 'https://cdn.jsdelivr.net/gh/liga-net/few-projects/local_election_search/'+file+'.json',
       async: false
    }).responseJSON.data;
    return value;
 }
 ...
 var data = getValue('local_dils1');
 var data = data.filter(d => d.city == 4)
...
{'name': 'ПРОГРЕСИВНА СОЦІАЛІСТИЧНА ПАРТІЯ УКРАЇНИ', 'id': 147}]
 ...
 function randomOutput(val) {
     ...
     random += '<div class="district"><img style="width: 8px; padding-right: 2px;" src="https://cdn.jsdelivr.net/gh/liga-net/few-projects/local_election_search/point.png"> ' +rayon_place + '</div>';
     random += '</div></div>';
     return random
 }
 ...
 var random = '<div class="local_row">';
 for (r=0;r<4;r++) {
 ...
 $('#local_txt_search').keyup(function(){
     function makeOutput (val,search) {
         ...
         if (search == 0) {
             ...
             if (sl != -1) {
                 ...
                 output += '<div class="district"><img style="width: 8px; padding-right: 2px;" src="https://cdn.jsdelivr.net/gh/liga-net/few-projects/local_election_search/point.png"> ' + word + '</div>';
             } 
             output += '<div class="district">Дільниця №' + val.dil + '</div>';
             output += '<div class="district"><img style="width: 8px; padding-right: 2px;" src="https://cdn.jsdelivr.net/gh/liga-net/few-projects/local_election_search/point.png"> ' + val.place.split(/,|:|;/)[0] + '</div>';
         } else if (search == 1) {
             output += '<div class="district" style="background-color: #ffecb3;"><img style="width: 8px; padding-right: 2px;" src="https://cdn.jsdelivr.net/gh/liga-net/few-projects/local_election_search/point.png"> ' + rayon_place + '</div>';
             output += '<div class="district">Дільниця №' + val.dil + '</div>';
             ...
             output += '<div class="district"><img style="width: 8px; padding-right: 2px;" src="https://cdn.jsdelivr.net/gh/liga-net/few-projects/local_election_search/point.png"> ' + rayon_place + '</div>';
             output += '<div class="district">Дільниця №' + val.dil + '</div>';
         ...
         var output = '<div class="local_row">';
         var count = 1;
     ...
     var span = document.getElementsByClassName('local_close')[0];
