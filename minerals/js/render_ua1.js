...
function bubbleChart(w) {
    ...
    svg.append("text")
        ...
        .text('Найбільші платники ренти за користуванням надрами');
    ...
    node.append("circle")
        ...
        .on("mouseover", function(d) {
            ...
            if (ben.includes(',')) {
                var ben_html = '<h4>Бенефіціари: </h4>'
            ...
            var html = ben_html+'<p><b>Сплаченої ренти:</b> '+rent+' грн</p><p><b>Кількість родовищ: </b>'+d.data.rod_count+'</p>'
    ...
    node.append("text")
        ...
        .text(function(d) {
            var size = d.r/8
            if (size > 3) {
                return d.data.beneficiary.substring(0, d.r / 3);
            }
...
{'col': '#d1bcd2', 'id': 5, 'label': 'Дорогоцінне каміння (бурштин)'},
{'col': '#43a2ca', 'id': 9, 'label': 'Вода підземна'},
{'col': '#D7AD6F', 'id': 13, 'label': 'Нерудні копалини для будівництва'},
...
var ukraine = getData('https://cdn.jsdelivr.net/gh/liga-net/few-projects/local_elections/ukraine.json').features;
    ...
    function render(){
        ...
        svg.append("text")
            ...
            .style("font-family", 'sans-serif')
            .style("font-weight", '600')
            .text('Карта українських родовищ');
        svg.append("text")
            .attr("x", width-50) 
            .attr("y", height-35)
            .attr("text-anchor", "middle")  
