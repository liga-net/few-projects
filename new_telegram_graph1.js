...
{'id':10,'name': 'Анатолий Шарий','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 119 раз</p>"},
{'id':11,'name': 'ОЛЬГА ШАРИЙ','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 573 раза</p>"},
{'id':12,'name': 'Klymenko Time','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 573 раза</p>"},
{'id':13,'name': 'Шептун','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 369 раз</p>"},
{'id':14,'name': 'НЕЗЫГАРЬ','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 25 раз</p>"},
{'id':15,'name': 'Макс Бужанский','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 225 раз</p>"},
{'id':16,'name': 'Тёмный Рыцарь','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 57 раз</p>"},
{'id':17,'name': 'наглый','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 208 раз</p>"},
{'id':18,'name': 'Тень на плетень','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 127 раз</p>"},
{'id':19,'name': 'Легитимный live','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 153 раза</p>"},
{'id':20,'name': '🏴‍☠️Бунтарь','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 74 раз</p>"},
{'id':21,'name': 'MediaKiller','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 35 раз</p>"},
{'id':22,'name': 'Скептик','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 13 раз</p>"},
{'id':23,'name': 'Криоген','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 20 раз</p>"},
{'id':24,'name': 'Одесский фраер','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 12 раз</p>"},
{'id':25,'name': 'Киев Власть','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 21 раз</p>"},
{'id':26,'name': 'UKRMedia','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 87 раз</p>"},
{'id':27,'name': 'Киевский Кейс','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 39 раз</p>"},
{'id':28,'name': 'PavlovskyNews','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 69 раз</p>"},
{'id':29,'name': 'цибуля','group': 2,'value': 0,'reposted': "<p>Анализируемые каналы репостнули его 30 раз</p>"}
  ],
  "links": [
  ...
  svg.append("text")
    ...
    svg.append("text")
      ...
      svg.append("text")
        ...
        .style("font-family", "sans-serif")
        .style("fill", "#bdbdbd")
        .text('Данные: 1 февраля - 18 ноября');
        ...
        svg.append("text").attr("x", 25).attr("y", legendX+5).text("Каналы из списка СБУ").style("font-size", "14px").attr("alignment-baseline","left")
        svg.append("text").attr("x", 25).attr("y", legendY+5).text("Другие").style("font-size", "14px").attr("alignment-baseline","left")
