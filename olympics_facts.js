...
function makeColumnChart(id, w) { 
    ...
    if (id == 'team_revenue') {
        ...
        var date = ["Токио", "Пхеньян", "Рио", "Сочи", "Лондон", "Ванкувер", "Пекин", "Турин", "Афины", "Солт Лейк Сити", "Сидней", "Нагано", "Атланта", "Лиллехаммер", "Барселона"]
        var json = [28,12.9,13.7,21.9,15,2.5,6.8,4.4,2.9,2.5,5,2.2,4.2,2.2,9.7]
        var tooltipHtml = '<p>'
        var left = 170
        var id_height = 600
        var title = "Большие траты на организацию Олимпийских игр"
    } 
    if (start_width > 500) {
        var tickValue = 7
        var fontSize = '16px'
