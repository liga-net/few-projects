...
var yearlyData = [
    {"date":"1992-01-01","value":1450},
    {"date":"1993-01-01","value":2593},
    {"date":"1994-01-01","value":2146},
    {"date":"1995-01-01","value":2299},
    {"date":"1996-01-01","value":3550},
    {"date":"1997-01-01","value":3648},
    {"date":"1998-01-01","value":3849},
    {"date":"1999-01-01","value":4042},
    {"date":"2000-01-01","value":2228},
    {"date":"2001-01-01","value":2849},
    {"date":"2002-01-01","value":3450},
    {"date":"2003-01-01","value":3327},
    {"date":"2004-01-01","value":6276},
    {"date":"2005-01-01","value":2318},
    {"date":"2006-01-01","value":4307},
    {"date":"2007-01-01","value":5335},
    {"date":"2008-01-01","value":8487},
    {"date":"2009-01-01","value":30923},
    {"date":"2010-01-01","value":21857},
    {"date":"2011-01-01","value":36463},
    {"date":"2012-01-01","value":40332},
    {"date":"2013-01-01","value":25559},
    {"date":"2014-01-01","value":7814},
    {"date":"2015-01-01","value":13385},
    {"date":"2016-01-01","value":11605},
    {"date":"2017-01-01","value":5916},
    {"date":"2018-01-01","value":5587},
    {"date":"2019-01-01","value":4748},
    {"date":"2020-01-01","value":4199},
...
function makeBarChart(w,uploaded_data,id) {
    ...
    svg.append("text")
        ...
        .text('Витрати бюджету на виготовлення нагород');
    svg.append("text")
        .attr("x", 0) 
...
function makeHorizontalBarChart(w,id) { 
    ...
    if (id == 'presidents') {
        ...
        var date = ["Кравчук","Кучма","Ющенко","Янукович","Порошенко","Зеленський"]
        var title = 'Нагороди і президенти'
        var yPadding = 24
        var he = 350
        var subtitle = ""
        ...
        var title = 'Найбільш популярні нагороди'
        var he = 450
        var subtitle = "Дані: відкриті дані Верховної Ради"
    }
    ...
    .append("rect")
        ...
        .on("mouseover", function(d,i) {
            if (id == 'presidents') {
                tooltipBee.html('<p>'+date[i]+' нагородив '+numberWithSpaces(d)+' людей')
            } else if (id == 'rewards_type') {
                tooltipBee.html('<p>Нагороду "'+date[i]+'" отримали '+numberWithSpaces(d)+' людей')
            }
            tooltipBee.style("visibility", "visible")
        })
        .on("mousemove", function() {
    ...
    svg.selectAll("mybar")
        ...
        .attr("x", function(d,i) {
            if (date[i] == 'Кравчук'|| date[i] == 'Зеленський') {
                return x(json[i])+20; 
            } else {
                return x(json[i])-25; 
            }
...
{"name": "За Мужність ІІІ Ступеня", "group": "Зеленський", "weight": "444" },
{"name": "Мати-Героїня", "group": "Зеленський", "weight": "359" },
{"name": "Захиснику Вітчизни", "group": "Зеленський", "weight": "306" },
{"name": "За Військову Службу Україні", "group": "Зеленський", "weight": "302" },
{"name": "За Заслуги ІІІ Ступеня", "group": "Зеленський", "weight": "277" },]
...
var pres = ['Кравчук', "Кучма",'Ющенко','Янукович','Порошенко','Зеленський']
...
svg.append("text")
        ...
        .style("font-size", fontSize)
        .style("font-family", "Georgia")
        .text('Кількість нагороджених людей по роках');
    svg.append("text")
        .attr("x", 0) 
        .attr("y", height + margin.bottom-5)
        .attr("text-anchor", "left")  
        ...
        var botdata = [
            {"group": "1992","Зеленський": 0,"Кравчук": 1450,"Кучма": 0,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "1993","Зеленський": 0,"Кравчук": 2593,"Кучма": 0,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "1994","Зеленський": 0,"Кравчук": 1073,"Кучма": 1073,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "1995","Зеленський": 0,"Кравчук": 0,"Кучма": 2299,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "1996","Зеленський": 0,"Кравчук": 0,"Кучма": 3550,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "1997","Зеленський": 0,"Кравчук": 0,"Кучма": 3648,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "1998","Зеленський": 0,"Кравчук": 0,"Кучма": 3849,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "1999","Зеленський": 0,"Кравчук": 0,"Кучма": 4042,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "2000","Зеленський": 0,"Кравчук": 0,"Кучма": 2228,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "2001","Зеленський": 0,"Кравчук": 0,"Кучма": 2849,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "2002","Зеленський": 0,"Кравчук": 0,"Кучма": 3450,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "2003","Зеленський": 0,"Кравчук": 0,"Кучма": 3327,"Порошенко": 0,"Ющенко": 0,"Янукович": 0},
    {"group": "2004","Зеленський": 0,"Кравчук": 0,"Кучма": 3138,"Порошенко": 0,"Ющенко": 3138,"Янукович": 0},
    {"group": "2005","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 2318,"Янукович": 0},
    {"group": "2006","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 4307,"Янукович": 0},
    {"group": "2007","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 5335,"Янукович": 0},
    {"group": "2008","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 8487,"Янукович": 0},
    {"group": "2009","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 30923,"Янукович": 0},
    {"group": "2010","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 10928,"Янукович": 10928},
    {"group": "2011","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 0,"Янукович": 36463},
    {"group": "2012","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 0,"Янукович": 40332},
    {"group": "2013","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 0,"Янукович": 25559},
    {"group": "2014","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 7814,"Ющенко": 0,"Янукович": 306},
    {"group": "2015","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 13385,"Ющенко": 0,"Янукович": 0},
    {"group": "2016","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 11605,"Ющенко": 0,"Янукович": 0},
    {"group": "2017","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 5916,"Ющенко": 0,"Янукович": 0},
    {"group": "2018","Зеленський": 0,"Кравчук": 0,"Кучма": 0,"Порошенко": 5587,"Ющенко": 0,"Янукович": 0},
    {"group": "2019","Зеленський": 2374,"Кравчук": 0,"Кучма": 0,"Порошенко": 2374,"Ющенко": 0,"Янукович": 0},
    {"group": "2020","Зеленський": 4199,"Кравчук": 0,"Кучма": 0,"Порошенко": 0,"Ющенко": 0,"Янукович": 0}
    ]
  
  
  var subgroups = ["Кравчук","Кучма","Ющенко","Янукович","Порошенко","Зеленський"]
  ...
  svg.append("g")
    ...
    .on("mouseover", function(d) {
        ...
        if (number == 1) {
            subgroups.forEach(function(k) {
                if (data_json[k] != 0) {
                    html += '<p>'+k+' нагородили '+data_json[k]+' людей</p>'
                }
            })
        } else {
            var last_name = ''
            ...
            html += '<p>'+last_name+'нагородили '+people+' людей</p>'
        }
