...
var dead_russians = [{'date': '26.02.2022', 'value': 2700},
 ...
 {'date': '24.08.2022', 'value': 3}]
    ...
    function makeAreaChart(id,data) {
        if (id == 'dead_russians') {
  ...
  if (w < 600) {
    ...
    makeAreaChart('dead_russians',dead_russians)
    makeAreaChart('bbm',bbm)
    makeAreaChart('tanks',tanks)
    makeAreaChart('artillery',artillery)
    makeAreaChart('jet',jet)
    makeAreaChart('helicopter',helicopter)
