Highcharts.chart('tax_country', {
    ...
    title: {
        text: 'Ставки основных налогов в Украине и ее соседях'
    },
    subtitle: {
        text: 'Источник: PWC'
    },
...
var belarus_data = [
    {"id":'vvp','type':'line','title':'ВВП Украины','subtitle':'Данные: Мировой Банк','dataLabels':false,'pointStart':1992,'stacking':undefined,'prefix':'$','suffix':'','series':[{name: 'Украина',showInLegend: false,color:'#fbc02d',data: [73942235330.44,65648559903.06,52549555149.20,48213868178.09,44558077827.14,50150399791.65,41883241471.74,31580639045.45,31261527363.14,37972301334.67,42351593887.28,50084197498.45,64819702951.68,86057915585.30,107647920792.08,142579603960.40,179816790704.74,117113410001.03,136013155905.04,163159671670.27,175781379051.43,183310146378.08,133503411375.74,91030959454.70,93355993628.50,112190355158.18,130901858421.72,153781069118.15]}]},
    {"id":'tax_rev','type':'line','title':'Доходы госбюджета от налогов от ВВП','subtitle':'Данные: Мировой Банк','dataLabels':false,'stacking':undefined,'pointStart':1999,'prefix':'','suffix':'%','series':[{name: 'Украина',color:'#fbc02d',data: [13,14.1,12.1,13.1,13.7,13.3,17.1,17.8,16.5,17.9,16.4,15.6,18.5,18.3,17.6,17.3,20.5,19.6,20,20.1]}, {name: 'Грузия',color:'#ff5722',data: [7.9,7.7,7.4,7.6,7,9.9,12.1,15.4,17.7,23.8,23.1,21,22.8,23.2,22,22,22.2,22.3,22.1,21.7]},{name: 'Польша',color:'#4caf50',data: [18.1,17,16.1,16.9,16.7,15.7,16.5,17.2,18.1,18.2,15.9,16.5,16.6,15.9,15.5,15.5,15.7,16.2,16.8,17.4]}, {name: 'Румыния',color:'#607d8b',data: [17.1,18,16.6,16.5,17.8,17.4,17.5,17.9,17.5,16.8,15.3,16.6,18.1,18,17.7,17.9,19,16.8,15.5,14.6]}]},
