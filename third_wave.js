...
var codesUkr = [{'name': 'robe_current', 'rus': 'Халаты изоляционные одноразовые'},
    {'name': 'respirator_ffp3_current',
    'rus': 'Респираторы класса FFP2'},
    {'name': 'mask_disposable_current',
    'rus': 'Одноразовые хирургические маски'},
    {'name': 'mask_reusable_current',
    'rus': 'Многоразовые хирургические маски'},
    {'name': 'glasses_disposable_current',
    'rus': 'Одноразовые защитные щитки и очки'},
    {'name': 'glasses_reusable_current',
    'rus': 'Многоразовые защитные щитки и очки'},
    {'name': 'gloves_current',
    'rus': 'Перчатки нитриловые'},
    {'name': 'total_ivl_work', 'rus': 'Общее количество исправных ИВЛ'},
    {'name': 'equipment_oxygen_concentrator',
    'rus': 'Количество кислородных концентраторов'},
    {'name': 'centralized_oxygen_system',
    'rus': 'Наличие системы централизованного снабжения кислорода'},
    {'name': 'equipment_ivl_oxygen_concentrator',
    'rus': 'Количество кислородных генераторов к ИВЛ'}]
