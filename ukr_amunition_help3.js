...
var world_data = [
{"country":"US","value":4,"rus":"США","desc":"Более 1500 тонн вооружения и боеприпасов (в том числе Javelin и гранатометы SMAW-D)","delivery":"1"},
{"country":"US","value":5,"rus":"США","desc":"2 катера Island","delivery":"1"},
{"country":"US","value":5,"rus":"США","desc":"Вертолеты Ми-17","delivery":"0"},
{"country":"US","value":4,"rus":"США","desc":"Еще около 20 рейсов с вооружением и боеприпасами по 80 тонн в среднем.","delivery":"0"},
...
{"country":"Canada","value":4,"rus":"Канада","desc":"Пулеметы, пистолеты, карабины, 1,5 млн патронов, снайперские винтовки и сопутствующее оборудование на сумму более $5,5 млн ","delivery":"1"},
{"country":"Lithuania","value":5,"rus":"Литва","desc":"Автомобили HMMWV (минимум пять)","delivery":"1"},
{"country":"Lithuania","value":1,"rus":"Литва","desc":"Более 500 бронежилетов и баллистические пояса","delivery":"1"},
...
{"country":"Afghanistan","value":0,"rus":"Афганистан"},
...
function makeWorldMap(id,w) {
        ...
        .on("mouseover", function(d) {
            ...
            if (country.length>0){
                ...
                if (country['value'] > 0) {
                    ...
                    var returnValue = filt.map(x => x.desc).join('</li><li>')
                    tooltipBee.html(
                        '<h4>'+country['rus']+'</h4><ul><li>'+returnValue+'</li></ul>'
                    )
                } else {
                    if (country['rus'] != 'Россия') {
                        tooltipBee.html(
    ...
    var keys = ['Амуниция', 'Военные инструкторы', 'Деньги', 'Оружие и боеприпасы', 'Техника'];
