    ...
    var locale = d3.timeFormatLocale({
        ...
        function makeBarChart(w,uploaded_data,id) {
            ...
            svg.append("text")
                ...
                .text('Кількість вакцинованих щотижня');
        ...
        svg.selectAll("mybar")
          ...
          .append("rect")
            ...
            .on("mouseover", function(d,i) {
                ...
                tooltipBee.html("<h4>"+formatDay(parseDate(d.date))+'-'+formatDay(parseDate(next_date))+'</h4><p>'+numberWithSpaces(d.value)+' вакцинованих</p>')
        ...
        var places = getData('https://cdn.jsdelivr.net/gh/liga-net/few-projects/places.json');
        ...
        function makeMap(w,id) {
            ...
            if (id == 'places') {
                ...
                var max_value = 118
                var min_value = 1
                var title = 'Кількість пунктів щелпення, по населенних пунктах'
            } else if (id == 'bad_days') {
                var json = bad_days
                var max_value = 170
                var min_value = 105
                var title = 'Пункти вакцинації, де не було вакцин більше 105 днів'
            }
