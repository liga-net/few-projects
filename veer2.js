...
function makeBarChart(w,uploaded_data,id) {
    ...
    svg.append("text")
        ...
        .text('Кількість повідомлень про віялові відключення');
...
{"State": "Еспресо TV","Позитив": 0,"Негатив": 13,"Нейтрал": 31,"total": 44},
{"State": "112 Україна (YouTube)","Позитив": 1,"Негатив": 11,"Нейтрал": 31,"total": 43},
