...
function makeBarChart(w,uploaded_data,id) {
    ...
    svg.append("text")
        ...
        .text('Количество сообщений про веерные отключения');
...
svg.selectAll("mybar")
  ...
  .append("rect")
    ...
    .on("mouseover", function(d,i) {
        tooltipBee.html("<h4>"+d.full+'</h4><p>'+numberWithSpaces(d.value)+' публикаций</p>')
...
function horizontalBarChart(w,data,id) {
    ...
    if (id == 'sources_ton'){
        start_height = 600
        var left = 160;
        var title = 'Тональность сообщений в медиа'
